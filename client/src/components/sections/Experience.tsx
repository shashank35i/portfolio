...
export function Experience() {
  return (
    <section id="experience" data-section-theme="zinc" className="section-flow py-20 md:py-24">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-display mb-5 md:mb-6">Experience</h2>
          <div className="w-16 h-1 bg-primary" />
        </motion.div>

        <div className="max-w-3xl mx-auto relative border-l border-border/40 ml-3 md:ml-0 pl-6 md:pl-8">
          {content.experience.map((job, idx) => (
            <motion.div
              ...
              className="mb-10 md:mb-12 relative md:grid md:grid-cols-[200px_1fr] md:gap-10"
            >
              {/* Timeline Dot */}
              <div className="absolute left-[-29px] md:left-[-8px] top-1.5 w-3.5 h-3.5 md:w-4 md:h-4 rounded-full bg-background border-2 border-primary" />
