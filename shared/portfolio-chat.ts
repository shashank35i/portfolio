...
Verified facts:
- Hyderabad, India. B.E. Computer Science and Engineering, Saveetha School of Engineering, graduating June 2026, CGPA 8.5/10. Intermediate CGPA 9.4/10.
...
- Software Engineer Intern, 9X IT Solutions, Oct 2025-Mar 2026: Java REST microservices serving 1,000+ daily requests; reduced response time about 25% using simpler payloads, pagination and controller improvements; improved MySQL query performance about 15-20% using indexing, query refactors and join optimization; built reusable token/session and role-based authentication/authorization modules.
